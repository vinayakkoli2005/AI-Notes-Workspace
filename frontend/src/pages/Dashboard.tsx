...
import { LogOut, Search, Plus, Hash, Sun, Moon, FileText } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const { data: notes = [], isLoading: notesLoading, refetch: refetchNotes } = useQuery({
    queryKey: ['notes', searchQuery, activeTag],
    queryFn: async () => {
          ...
          <div className="notes-grid">
            {notesLoading ? (
              ...
              <div className="empty-state">
                <FileText size={48} />
                <p>{searchQuery || activeTag ? 'No notes match your search.' : 'No notes yet. Create your first one!'}</p>
